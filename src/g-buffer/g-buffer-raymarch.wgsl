...
//      var debugColour = vec4(f32(closestIntersection.iterations)/ 8.0);
       if(closestIntersection.iterations > 16){
          debugColour = vec4(0,f32(closestIntersection.iterations)/ 128.0,f32(closestIntersection.iterations)/ 128.0,1);
      }
      if(closestIntersection.iterations > 32){
        debugColour = vec4(0,f32(closestIntersection.iterations)/ 128.0,0,1);
      }
      if(closestIntersection.iterations > 64){
        debugColour = vec4(f32(closestIntersection.iterations)/ 128.0,0,0,1);
      }
